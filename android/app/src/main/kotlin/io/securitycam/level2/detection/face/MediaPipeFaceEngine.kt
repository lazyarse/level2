...
class MediaPipeFaceEngine(
    ...
    override suspend fun detectFaces(frame: io.securitycam.level2.detection.ColorBitmap): List<FaceDetection> {
    ...
    private fun toBitmap(frame: io.securitycam.level2.detection.ColorBitmap): Bitmap {
