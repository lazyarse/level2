...
import io.securitycam.level1.core.PrivacyMaskEffect
...
class PrivacyMaskOverlayTest {
    ...
    private val rectRegion = io.securitycam.level1.detection.DetectionRegion(
        id = "r1",
        shape = "rect",
        label = "Door",
    ...
    private val polyRegion = io.securitycam.level1.detection.DetectionRegion(
        id = "p1",
        shape = "poly",
        label = "Window",
