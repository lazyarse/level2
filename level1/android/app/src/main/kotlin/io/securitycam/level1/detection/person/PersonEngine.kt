...
interface PersonEngine {
    ...
    suspend fun detectPersons(frame: io.securitycam.level1.detection.ColorBitmap): List<PersonBox>
...
class MockPersonEngine : PersonEngine {
    ...
    override suspend fun detectPersons(frame: io.securitycam.level1.detection.ColorBitmap): List<PersonBox> =
        persons.toList()
