...
/**
 * Cat-detection trigger. Runs on color analysis frames (motion-gated by the
 ...
 *
 * Uses the shared YOLO26n model via [YoloCatEngine] — zero extra model
...
class CatDetector(
    ...
    private val engine: CatEngine = engine ?: YoloCatEngine(AppContextHolder.require())
