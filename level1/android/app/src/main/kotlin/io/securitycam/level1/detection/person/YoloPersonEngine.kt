...
/**
 * YOLO26n (`yolo26n_w8a32.tflite`) via LiteRT Next [CompiledModel] (port of
 * `yolo_person_engine.dart`). The `format=litert` export targets the Next
 * runtime. Preprocesses the BGR [ColorBitmap] to a 640x640 RGB NCHW float32
 * tensor, runs inference, and decodes + NMSes person boxes.
 */
class YoloPersonEngine(
    ...
    companion object {
        ...
        const val MODEL_ASSET = "yolo26n_w8a32.tflite"
    }
}