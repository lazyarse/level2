...
class GlassBreakDetector extends AudioDetector {
  @override
  final DetectorConfig config;
  int _persistenceCount = 0;

  GlassBreakDetector(this.config);

  @override
  String get id => config.type;

  @override
  String get triggerType => TriggerType.glassBreak;
  ...
  DetectionResult analyzeScores(AudioEventScores scores) {
    final score = scores.scoreOf('glass');
