...
class LoudNoiseDetector extends AudioDetector {
  @override
  final DetectorConfig config;
  int _persistenceCount = 0;

  LoudNoiseDetector(this.config);

  @override
  String get id => config.type;

  @override
  String get triggerType => TriggerType.loudNoise;
  ...
  DetectionResult analyzeScores(AudioEventScores scores) {
    final score = scores.scoreOf('loud_noise');
